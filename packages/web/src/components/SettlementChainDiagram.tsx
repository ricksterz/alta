...
const EXTENDED: DiagramSpec = {
  ...
  nodes: [
    ...
    { role: "escrow", x: 1090, y: 300, w: 160, h: 64, tag: "party 5", label: "Escrow Agent", labelFontSize: 13.5 },
    { role: "custodian", x: 1310, y: 300, w: 160, h: 64, tag: "party 6", label: "Custodian" },
  ...
  edges: [
    ...
    { id: "edgeTrunk2", kind: "trunk", d: "M 952 300 L 1010 300" },
    { id: "edgeTrunk3", kind: "trunk", d: "M 1170 300 L 1230 300" },
  ...
  particleLanes: [
    ...
    { edgeId: "edgeTrunk2", cls: "trunk", count: 3, duration: 1.4, radius: 3.6, phase: 0.15 },
    { edgeId: "edgeTrunk3", cls: "trunk", count: 3, duration: 1.3, radius: 3.6, phase: 0.3 },
...
const ROLES: Record<string, { label: string; tag: string; text: string }> = {
  ...
  escrow: {
    label: "Escrow Agent",
    tag: "party 5",
    text: "Holds subscribed capital until a drawdown fund's first-close minimum is actually met, before releasing it to the fund. Sits between the administrator's acceptance and the custodian's funding confirmation.",
  },
  custodian: {
    label: "Custodian",
    tag: "party",
