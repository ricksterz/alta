      ...
      <div>
        {terms ? (
          <dl className="grid grid-cols-2 gap-3 text-sm">
            <div>
              <dt className="text-xs uppercase text-slate-400">Management fee</dt>
            ...
            <div>
              <dt className="text-xs uppercase text-slate-400">Carried interest</dt>
              <dd className="font-medium text-slate-800">{pct(terms.carriedInterestRate)}</dd>
            </div>
            <div>
              <dt className="text-xs uppercase text-slate-400">Hurdle rate</dt>
              <dd className="font-medium text-slate-800">{pct(terms.hurdleRate)}</dd>
            </div>
            <div>
              <dt className="text-xs uppercase text-slate-400">Waterfall</dt>
              <dd className="font-medium capitalize text-slate-800">{terms.waterfallType ?? "—"}</dd>
            </div>
            <div>
              <dt className="text-xs uppercase text-slate-400">Fund term</dt>
              <dd className="font-medium text-slate-800">
          ...
          <p className="text-sm text-slate-400">No economics recorded yet.</p>
        )}
        <button
          type="button"
          onClick={() => setEditing(true)}
          className="mt-4 rounded border border-slate-300 px-3 py-1.5 text-xs font-medium text-slate-700 hover:bg-slate-100"
        >
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label className="mb-1 block text-xs font-medium text-slate-600">Management fee %</label>
          <input
            type="number"
            step="0.01"
        ...
        <div>
          <label className="mb-1 block text-xs font-medium text-slate-600">Fee basis</label>
          <select
            className="w-full rounded border border-slate-300 px-2 py-1.5 text-sm"
        ...
        <div>
          <label className="mb-1 block text-xs font-medium text-slate-600">Carried interest %</label>
          <input
            type="number"
            step="0.01"
            className="w-full rounded border border-slate-300 px-2 py-1.5 text-sm"
        ...
        <div>
          <label className="mb-1 block text-xs font-medium text-slate-600">Hurdle rate %</label>
          <input
            type="number"
            step="0.01"
            className="w-full rounded border border-slate-300 px-2 py-1.5 text-sm"
        ...
        <div>
          <label className="mb-1 block text-xs font-medium text-slate-600">Waterfall</label>
          <select
            className="w-full rounded border border-slate-300 px-2 py-1.5 text-sm"
            value={waterfallType}
        ...
        <div>
          <label className="mb-1 block text-xs font-medium text-slate-600">Fund term (years)</label>
          <input
            type="number"
            className="w-full rounded border border-slate-300 px-2 py-1.5 text-sm"
            placeholder="10"
...
function EligibilityTogglesPanel({ fund, onSaved }: { fund: FundDetail; onSaved: () => void }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <p className="mb-2 text-xs font-semibold uppercase tracking-wide text-slate-400">Transfer terms</p>
        <div className="space-y-1.5">
          <label className="flex items-center gap-2 text-sm text-slate-700">
        ...
        <div className="mt-2 max-w-[10rem]">
          <label className="mb-1 block text-xs font-medium text-slate-600">Lock-up (months)</label>
          <input
            type="number"
            className="w-full rounded border border-slate-300 px-2 py-1.5 text-sm"
            value={lockupMonths}
